  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <label htmlFor="enableErrorTracking" className="text-sm font-medium text-gray-700">
              Error Tracking
            </label>
            <p className="text-sm text-gray-500">
        ...
        <div className="flex items-center justify-between">
          <div>
            <label htmlFor="autoRefreshStats" className="text-sm font-medium text-gray-700">
