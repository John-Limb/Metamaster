...
class TestEnvironmentVariableConfiguration:
    ...
    def test_docker_compose_test_env_variables(self):
        ...
        assert "DEBUG=True" in content or "DEBUG: \"True\"" in content, "Debug mode not enabled for tests"
        # Test environment should have LOG_LEVEL=DEBUG
        assert "LOG_LEVEL=DEBUG" in content or "LOG_LEVEL: \"DEBUG\"" in content, "Debug log level not set for tests"
    ...
    def test_environment_variable_substitution(self):
        ...
        assert "${" in content or "$(" in content or "environment:" in content, \
